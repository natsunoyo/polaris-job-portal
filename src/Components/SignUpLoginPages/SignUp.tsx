...
const SignUp = () => {
    ...
    return <div className="w-1/2 px-20 flex flex-col justify-center gap-2">
        ...
        <Button onClick={handleSubmit} color="purpleHeart.4" size="md" variant="filled">Зареєструватися</Button>
